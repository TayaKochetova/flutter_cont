...
/*+ Нужно создать класс бабочки, у которого будут параметры **имя** и **описание**
У вас получится массив объектов Бабочек
+ Добавьте на странице поле для поиска бабочки по названию: 
пользователь вводит название бабочки. Если такая бабочка есть в списке, 
то ее надо выделить, как будто на нее нажали, а внизу должно появиться ее описание.
- Если такой бабочки нет, выводите ошибку "Такой бабочки нет в списке"
+ Добавьте валидацию для поля поиска*/
